...
function setActiveTool(newTool) {
	...
	// убрать активное у всех
	document
		.querySelectorAll("#toolbar button:not(.thicknessBtn)")
	...
	if (tool !== "eraser") {
		// подсветка цвета для pencil / highlighter
		document.querySelectorAll(".colorBtn").forEach((btn) => {
			if (btn.style.background === color) btn.classList.add("active");
